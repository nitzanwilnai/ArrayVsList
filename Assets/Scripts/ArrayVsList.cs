...
public class UnsafeIndexerArray
{
    public int[] Array;

    public UnsafeIndexerArray()
    {
        Array = new int[1024];
    }
...
public class SafeIndexerArray
{
    public int[] Array;

    public SafeIndexerArray()
    {
        Array = new int[1024];
    }
...
public class ArrayVsList : MonoBehaviour
{
    ...
    SafeIndexerArray safeArray = new SafeIndexerArray();
    UnsafeIndexerArray unsafeArray = new UnsafeIndexerArray();
    ...
    unsafe void TestCache()
    {
        ...
        ResultText.text += "Safe Indexer Array " + timer5.ToString("N4") + "\n";
        ResultText.text += "UnSafe Indexer Array " + timer6.ToString("N4") + "\n";
